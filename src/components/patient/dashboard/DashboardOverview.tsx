...
const DashboardOverview = ({ isVisible, progress, mockDoctor, handleStartTherapy }: DashboardOverviewProps) => {
  ...
  return (
    <div className={`space-y-6 transition-opacity duration-500 ${isVisible ? 'opacity-100' : 'opacity-0'}`}>
      {/* Progress Section */}
      <ProgressSection progress={progress} handleStartTherapy={handleStartTherapy} />
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="space-y-6">
          ...
          <div>
            ...
            {mockDoctor.id ? (
              <TherapistCard doctor={mockDoctor} />
            ) : (
