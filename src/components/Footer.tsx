        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li>
                <Link to="/self-care-tips" className="text-muted-foreground hover:text-primary transition-custom">
                  {t('self_care_tips')}
                </Link>
              </li>
              <li>
                <Link to="/faq" className="text-muted-foreground hover:text-primary transition-custom">
                  {t('faq')}
                </Link>
              </li>
            </ul>
             ...
             <li className="flex items-start space-x-3 text-muted-foreground">
              ...
              <li>
                <div className="flex items-center gap-4">
                  ...
                  <a href="#" className="text-muted-foreground hover:text-primary transition-custom" aria-label="Instagram">
                    <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                  ...
                  <a href="#" className="text-muted-foreground hover:text-primary transition-custom" aria-label="Facebook">
                    <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
