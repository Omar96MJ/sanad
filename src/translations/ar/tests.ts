...
const testsTranslations = {
  ...
  'adhdtitle': 'اختبار فرط الحركة وتشتت الانتباه',
  'adhdshort': 'فرط الحركة وتشتت الانتباه',
  'adhdlong': 'اضطراب فرط الحركة ونقص الانتباه',
  'anxietytitle': 'اختبار القلق',
  'anxietydesc': 'قياس مستوى القلق',
  'depressiontitle': 'اختبار الاكتئاب',
  'depressiondesc': 'تحقق من علامات الاكتئاب',
  'ptsdtitle': 'اختبار اضطراب ما بعد الصدمة',
  'ptsddesc': 'تقييم أعراض ما بعد الصدمة',
  'wellnesstitle': 'فحص الرفاهية',
  'wellnessdesc': 'تتبع الرفاهية العامة',
  'starttest': 'ابدأ الاختبار',
  'testduration': 'المدة المتوقعة',
  'testquestions': 'عدد الأسئلة',
  'testdescription': 'الوصف',
  'results': 'النتائج',
  'retake': 'أعد الاختبار',
  'share': 'مشاركة',
  'traumadesc': 'التوعية بالصدمات',
  'traumatitle': 'اختبار الصدمة',
  'viewallposts': 'عرض جميع المنشورات',
  'wellbeingtests': 'اختبارات الرفاهية',
  'therapytypestitle': 'أنواع العلاج',
  'therapytypessubtitle': 'استكشف أنواع العلاجات',
  'tags': 'الوسوم',
  'stress': 'التوتر',
  'stressdesc': 'تقييم التوتر',
};
